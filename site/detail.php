                    ...
                    <div class="row px-xl-5">
                        ...
                        <div class="col-lg-7 pb-5">
                            ...
                            <div class="d-flex mb-3">
                                ...
                                <small class="pt-1">(50 lượt mua)</small>
                            </div>
                            <h3 class="font-weight-semi-bold mb-4"><?= $sanpham['price'] ?></h3>
                            <div class="d-flex mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="media mb-4">
                                                <img src="../uploads/users/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
